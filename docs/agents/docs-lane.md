...
This repo's shipping workflow: one ticket per run, driven end to end by the `docs-ship` skill with no human merge gate. This page is the map; the skill itself (`.claude/skills/docs-ship/SKILL.md`) is the source of truth for every step.
